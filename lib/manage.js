...
module.exports = function(config) {
	...
	function sync(schema) {
		...
		// create a new transaction to run the sync
		var t = config.knex.transaction(function(trx) {
	 ...
	 * @param {Object} schema - Database schema to drop.
	 * @returns {Promise}
	 */
	function drop(schema) {
		
		// create a new transaction and drop each
